  ...
  return (
    <View style={styles.card}>
      <View style={styles.cardContent}>
        <Text style={styles.cardTitle}>Telkomsel</Text>
      ...
      <View style={styles.cardBack}>
        ...
        <Text style={styles.instructions}>2. Ketik *133*kode_voucher#</Text>
        <Text style={styles.instructions}>3. Tekan panggil.</Text>
        <Text style={styles.footer}>Telkomsel</Text>
        <Text style={styles.footer}>www.telkomsel.com</Text>
      </View>
    </View>
  );
};
