  ...
  return (
    <View style={styles.card}>
      <View style={styles.cardContent}>
        <Text style={styles.cardTitle}>XL Axiata</Text>
      ...
      <View style={styles.cardBack}>
        ...
        <Text style={styles.instructions}>2. Ketik *123*kode_voucher#</Text>
        <Text style={styles.instructions}>3. Tekan panggil.</Text>
        <Text style={styles.footer}>XL Axiata</Text>
        <Text style={styles.footer}>www.xl.co.id</Text>
      </View>
    </View>
  );
};
